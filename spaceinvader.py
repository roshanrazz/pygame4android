...
screen=pygame.display.set_mode((1200,2400))

pygame.display.set_caption('space invadors')

icon=pygame.image.load('/storage/emulated/0/Download/space-invaders.png')
...
def start_screen():
	startscreen=pygame.image.load('/storage/emulated/0/Download/startscreen1.jpg')
	startgame=pygame.image.load('/storage/emulated/0/Download/rocket.png')
	quitgame=pygame.image.load('/storage/emulated/0/Download/close (1).png')
...
def playgame():
	global bltstate
	shipimg=pygame.image.load('/storage/emulated/0/Download/space-invaders.png')
	...
	for i in range (6):
		...
		enm.append(pygame.image.load('/storage/emulated/0/Download/alien.png'))
		enm.append(pygame.image.load('/storage/emulated/0/Download/ufo.png'))
		enmx.append(rd.randint(0,940))
		enmy.append(rd.randint(60,820))
	
	bckimg=pygame.image.load('/storage/emulated/0/Download/bgr.jpg')
	
	def enemy(x,y,i):
			screen.blit(enm[i],(x,y))
		
	blt=pygame.image.load('/storage/emulated/0/Download/bullet (1).png')
	bltx,blty=0,1800
	bltchange=0
	...
	def display_over():
		...
		mixer.music.load('/storage/emulated/0/Download/0917.ogg')
		mixer.music.play()
		plag=play_again.render('Do You Want To Play Again?',True,(0,255,22))
		screen.blit(plag,(100,900))
		yes=pygame.image.load('/storage/emulated/0/Download/yes.png')
		no=pygame.image.load('/storage/emulated/0/Download/close.png')
		screen.blit(yes,(350,1060))
		screen.blit(no,(650,1060))
	
	mixer.music.load('/storage/emulated/0/Download/backgroundmusic.mp3')
	mixer.music.play(-1)
	
	game_over=False

	left=pygame.image.load('/storage/emulated/0/Download/back.png')
	right=pygame.image.load('/storage/emulated/0/Download/next.png')
	bltbtn=pygame.image.load('/storage/emulated/0/Download/bullet (2).png')
	...
	while True:
			...
			if event.type==pygame.MOUSEBUTTONDOWN:
				...
				if (x>265 and x<700) and (y>1800 and y<2300) and not game_over:
					if bltstate is 'ready':
						bltsound=mixer.Sound('/storage/emulated/0/Download/shoot.wav')
						bltsound.play()
						bltx=shipx
						bullet(bltx,blty)
		...
		for i in range(6):
			...
			if killdist<90:
				enmsound=mixer.Sound('/storage/emulated/0/Download/explosion.wav')
				enmsound.play()
				blty=1800
				bltstate='ready'
				bltchange=0
